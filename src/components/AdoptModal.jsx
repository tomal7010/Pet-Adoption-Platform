      ...
      <div className="bg-white p-6 rounded shadow w-full max-w-md relative">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input value={user.name} disabled className="w-full border px-3 py-2 rounded bg-gray-100" />
          </div>

          <div>
            <label className="block text-sm">Email</label>
            <input value={user.email} disabled className="w-full border px-3 py-2 rounded bg-gray-100" />
          </div>
